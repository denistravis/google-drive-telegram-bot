...
class Messages:
    ...
    AUTH_TEXT = "⛓️ **Hi I'm Gdrive uploader Bot, To Authorize me upload to your Google Drive account visit this [URL]({}) and send the generated code here.**\n__Visit the URL > Allow permissions > you will get a code > copy it > Send it here, First join my channel for updates @gdriveuploader__"
